      ...
      <div class="card">
        <div class="card-body">
            ...
            <table class="table">
              ...
              <tbody>
                <tr *ngFor="let user of users">
                  ...
                  <td>
                    <button class="btn btn-info btn-sm me-2" (click)="selectUser(user)">Ver Detalles</button>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div *ngIf="selectedUser" class="user-details">
            <button class="btn btn-secondary mb-3" (click)="selectedUser = null">← Volver a la lista</button>
            ...
            <h4 class="mt-4">Fotografías del Usuario</h4>
            <div class="row">
